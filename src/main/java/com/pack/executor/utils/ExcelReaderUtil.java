...
/**
 * This class has methods to retrieve data from excel spreadsheet
 *
 * @author NageshP
 */
public class ExcelReaderUtil {
	...
	/**
	 * **************************************************************************************
	 * Read Excel path, it takes the path of the excel spreadsheet to be read
	 *
	 * @param path
	 ...
	 *
	 * @param sheetName
	 * @return Returns number of rows present in spreadsheet
	 *         **************************************************************************************
	 */
	 ...
	 *
	 * @param sheetName
	 * @return returns number of columns in a sheet
	 *         *************************************************************************
	 */
	 ...
	 * @param url
	 * @param message
	 * @return True if hyperlink is added to the sheet successfully
	 *         *************************************************************************************
	 */
	...
	/**
	 * *************************************************************************************
	 * To get the row number of the cell
	 *
	 * @param sheetName
	 * @param colName
	 * @param cellValue
